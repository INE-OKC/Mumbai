 ...
 * controlled by a central SupplyController. By implementing INEImplementation
...
contract INE {
    ...
    string public constant name = "INE Assets"; // solium-disable-line
    string public constant symbol = "INE"; // solium-disable-line uppercase
    ...
    */
    ...
    /**
     * @dev Reclaim all INE at the contract address.
     * This sends the INE tokens that this contract add holding to the owner.
     * Note: this is not affected by freeze constraints.
     */
    function reclaimINE() external onlyOwner {
